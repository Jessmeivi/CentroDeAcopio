        ...
        if($_POST)//Recibe los datos del formulario de abajo
        {
            ...
            if(!$conexion){
                ...
                if($result->num_rows > 0){
                    echo "<center> <h2 class='h2'>Seguro que desea eliminar este empleado ?</h2></center>";
                    echo "<center><table>";

                    while($row = $result->fetch_assoc()){  
                        echo "<tr> <td> <center> <b>Nombre</b><h4>* ".$row["nom"]."
                         ". $row["ape_pat"]." ". $row["ape_mat"].
                        "*</h4></center></td> </tr>";
                    }
                    echo "</table></center>";
                    echo "<form name='elim' action='http://localhost/conexion/elim_emp.php' method='POST'> <!--Igualmente el formulario se envia a la misma pagina--> 
                            <br>
                            <center><table>
                                <tr>
                                    <td>
                                        <input type='hidden' name='enviar2' value='$id'>
                                        <br><center> <input type='submit' class='btn' name='enviar' value='Aceptar'></center><br>
                                    </td>
                                </tr>
                            </table></center>
                        </form> </center>";
                ...
                echo "<center><a class='btn' href='http://localhost/conexion/inicio_emp.php'>Cancelar</a></center>";
            }
        }else{
    ?>
            <table class="center">
