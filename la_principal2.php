...
<body>
    ...
    $to=$duct['id'];
                ...
                <tr>
                    <td align='center'>
                        ...
                        <h3>recicladora : $nombre</h3> 
                    </td>
                </tr>
                <tr>
                    <td align='center'>
                        <form name='Registro' action='http://localhost/conexion/la_principal2.php' method='POST'> <!--Igualmente el formulario se envia a la misma pagina--> 
                ...
                <tr>
                    <td>
                    <form name='Registro' action='http://localhost/conexion/la_chida2.php' method='POST'> <!--Igualmente el formulario se envia a la misma pagina--> 
    ...
    <table class="center">
        <tr>
            <td align="center">
                <h1>INGRESE LOS DATOS (salida)</h1> <!--Formulario para la recicladora--> 
            </td>
        </tr>
        <tr>
            <td align="center">
                <form name="Registro" action="http://localhost/conexion/la_principal2.php" method="POST"> <!--Igualmente el formulario se envia a la misma pagina--> 
                    <div class="input-container">
                        <input type="text" name="nombre"><br><label>Nombre de la recicladora:</label><br>
                    </div>
                    <div class="input-container">
