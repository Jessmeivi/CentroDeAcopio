        ...
        if($_POST)//Recibe los datos del formulario de abajo
        {
            ...
            if(!$conexion){
                ...
                if($result->num_rows > 0){
                    echo "<center> <h2 class='h2'>Seguro que desea eliminar esta recicladora ?</h2></center>";
                    echo "<center><table>";

                    while($row = $result->fetch_assoc()){
                        echo "<tr> <td><b><h4> *".$row["nombre"]."
                        *</h4></td> </tr>";
                    }
                    echo "</table></center>";
                    echo "<center><form name='elim' action='http://localhost/conexion/elim_reci.php' method='POST'> <!--Igualmente el formulario se envia a la misma pagina--> 
                            <br><table>
                                <tr>
                                    <td>
                                        <input type='hidden' name='enviar2' value='$id'>
                                        <br><center><input type='submit' class='btn' name='enviar' value='aceptar'></center>
                                    </td>
                                </tr>
                            </table>
                            <br>
