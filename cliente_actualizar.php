            ...
            $id=$_POST['id'];
             echo "<hr style='border-color: red'>";
                ...
                if($result->num_rows > 0)
                {
                    ...
                    {
                echo"Nombre: <input type='text' name='nombre' value='".$row["nom_cliente"]."'><br>";
                
                echo"apellido paterno: <input type='text' name='ape_pat' value='".$row["ape_pat"]."'><br>";
                
                echo"apellido materno: <input type='text' name='ape_mat' value='".$row["ape_mat"]."'><br>";
                
               echo "estado: <input type='text' name='estado' value='".$row["estado"]."'><br>";
               echo "estado: <input type='text' name='colonia' value='".$row["colonia"]."'><br>";
                 
                echo"calle: <input type='text' name='calle' value='".$row["calle"]."'><br>";
                 
                echo"numero de casa : <input type='number' name='numero' value='".$row["numero"]."'><br>";

                echo"telefono: <input type='number' name='telefono' value='".$row["telefono"]."'><br>";
              echo"  <tr>";
                echo"<td>";
