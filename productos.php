...
<img class="logo" src="img/logo.png" alt="logo">
    ...
    <table class="center">
        <tr>
            <td align="center">
                <h2>Buscar por nombre</h2> <!--Formulario para crear al nuevo usuario--> 
            </td>
        </tr>
        <tr>
            <td align="center">
                <form name="Registro" action="http://localhost/conexion/Filtrar.php" method="POST"> <!--Igualmente el formulario se envia a la misma pagina--> 
