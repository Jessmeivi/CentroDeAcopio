    ...
    <?php
        if($_POST)//Recibe los datos del formulario de abajo
        {
            ...
            if(!$conexion){
                ...
                echo "<br>";
                $sql ="call listadoP($id)"; //Con esta consulta filtra todas las preguntas que contengan esa palabra clave
                ...
                if($result->num_rows > 0){
                    ...
                    while($row = $result->fetch_assoc()){
                        echo"<div class='input-container' > <input style='color:#FFFFFF' type='text' name='tipo' value='".$row["v1"]."'> <label style='color: #FFFFFF; '>Tipo de Producto: </label> </div><br>";
                
                        echo"<div class='input-container'><input style='color:#FFFFFF' type='text' name='desc' value='".$row["v2"]."'><label style='color:  #FFFFFF;'>Descripción Prod:   </label></div><br>";
                
                        echo"<div class='input-container'> <input style='color:#FFFFFF' type='number' name='precio' value='".$row["v3"]."'><label style='color:  #FFFFFF;'>Precio:  </label></div><br>";
                
                        echo "<div class='input-container'> <input style='color:#FFFFFF' type='number' name='cantidad' value='".$row["v4"]."'><label style='color:  #FFFFFF;'>Cantidad: </label></div><br>";
                        echo "<div class='input-container'> <input style='color:#FFFFFF' type='text' name='estado' value='".$row["v5"]."'><label style='color:  #FFFFFF;'>Estado del material:  </label></div><br>";
