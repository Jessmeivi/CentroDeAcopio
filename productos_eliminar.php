        ...
        if($_POST)//Recibe los datos del formulario de abajo
        {
            ...
            if(!$conexion){
                ...
                if($result->num_rows > 0){
                    echo "<center> <h2 class='h2'>Seguro que desea eliminar este producto ?</h2></center>";
                    echo "<center><table>";

                    while($row = $result->fetch_assoc()){
                        echo "<tr> <td> <center> <b> <h4>*".$row["tipo_prod"].
                        "*</h4></b> </center></td> </tr>";
                    }
                    echo "</table> </center>";
                    echo "<center><form name='elim' action='http://localhost/conexion/elim_prod.php' method='POST'> <!--Igualmente el formulario se envia a la misma pagina--> 
                   <br>
                        <table>
                            <tr>
                                <td>
